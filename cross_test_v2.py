...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_file", type=str, default='/mydata/shared/data_insupur/luwen/yekeyuan_luwen/MoE-AGIQA-master/MoE-AGIQA-master/checkpoint/agiqa3k_0216_2015/best.pth',
                        help="model file")
    ...
    args.data_info = '/mydata/shared/data_insupur/luwen/yekeyuan_luwen/MoE-AGIQA-master/MoE-AGIQA-master/data/AGIQA-1K.mat'
    ...
    '''
    text_prompts1 = [Info[Info['text_prompt1'][0, :][i]][()].tobytes()[::2].decode() for i in range(len(moss))]
    text_prompts2 = [Info[Info['text_prompt2'][0, :][i]][()].tobytes()[::2].decode() for i in range(len(moss))]
    text_prompts3 = [Info[Info['text_prompt3'][0, :][i]][()].tobytes()[::2].decode() for i in range(len(moss))]
    ...
    reward.eval()
    directory_name = "/mydata/shared/data_insupur/luwen/yekeyuan_luwen/dataset/AGIQA-1K/AGIQA-1k/file/"
    ...
    with torch.no_grad():
        ...
        for layer in model_vit.modules():
            ...
            preds = []
        with open('/mydata/shared/data_insupur/luwen/yekeyuan_luwen/MoE-AGIQA-master/results/Cross/output_3k_1k.txt', 'w') as file:
