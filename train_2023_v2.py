...
class IQADataset(Dataset):
    ...
    def __init__(self, args, transform, status, loader=default_loader):
        ...
        self.txt_prompts = []
        self.scale = Info['subjective_scores_correspondence'][0, :].max()
        self.mos = Info['subjective_scores_correspondence'][0, self.index] / self.scale
...
def parse_args():
    ...
    parser.add_argument('--num_avg_train', type=int, default=3, \
                    help='ensemble ways of train default=3')
    parser.add_argument('--num_avg_val', type=int, default=15, \
                    help='ensemble ways of validation default=15')
    ...
    if args.database == 'AIGCIQA2023':
        ...
        args.im_dir = '/mydata/shared/data_insupur/luwen/yekeyuan_luwen/dataset/AIGCIQA2023/Image/'
